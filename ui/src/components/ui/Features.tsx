...
export default function Features() {
  return (
    <section
      ...
      className=" custom-container sm:my-12 my-2"
    >
      {/* <Badge>Security at Scale</Badge> */}
      <div className="custom-container-card sm:mt-24 mt-4 sm:mb-24 mb-4 max-w-6xl 2xl:max-w-7xl px-3 sm:px-36 py-12 mx-auto border      rounded-xl  flex flex-col justify-start items-start">
        <h2
          id="features-title"
