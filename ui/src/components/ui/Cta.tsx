                  ...
                  <div className="flex-1 pb-6 [&amp;>*+*]:mt-5 w-full">
                    ...
                    >
                      ...
                      <div className="grid-area-1-1 z-[1] mt-[0.5em] text-black dark:text-white">
                        Run Helm Install <span className="emoji ">⏱️</span> 5-7
                        Mins
                      </div>
                    </h4>
                    <div className="group/codeblock grid grid-flow-col w-full mx-auto decoration-primary/6 ">
                ...
                <div className="flex flex-row gap-4 md:gap-8  w-full mx-auto">
                  ...
                  <div className="flex-1 pb-6 [&amp;>*+*]:mt-5 w-full">
                    ...
                    <p className="w-full text-black dark:text-white mx-auto  justify-start text-start f mt-5">
                      ...
                      <code className="py-[1px] px-1.5 min-w-[1.625rem] inline-flex justify-center items-center ring-1 ring-inset ring-offset-dark-tremor-background-emphasis bg-dark-tremor-background-emphasis rounded text-dark/8 dark:ring-light/1 dark:bg-light/1 dark:text-light/7 text-[.875em] leading-[calc(max(1.20em,1.25rem))]">
                        <strong className="font-bold">
                          admin@opencomply.io
                        </strong>
                      </code>{" "}
                      as the username and{" "}
                      <code className="py-[1px] px-1.5 min-w-[1.625rem] inline-flex justify-center items-center ring-1 ring-inset ring-dark/1 bg-dark-tremor-background-emphasis rounded text-dark/8 dark:ring-light/1 dark:bg-light/1 dark:text-light/7 text-[.875em] leading-[calc(max(1.20em,1.25rem))]">
